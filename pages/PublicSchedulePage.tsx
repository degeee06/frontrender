                    ...
                    <div className="space-y-5">
                       ...
                       <div>
                           ...
                           <div className="relative">
                               <User className="absolute inset-y-0 left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-steel" />
                               <input type="text" id="nome" placeholder="Seu nome completo" {...register('nome', { required: true })}
                                      className="w-full pl-10 pr-4 py-3 rounded-lg bg-black-medium border border-black-light focus:outline-none input-field text-sm text-white placeholder-gray-steel" />
                           </div>
                       </div>
                       <div>
                           ...
                           <div className="relative">
                               <Mail className="absolute inset-y-0 left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-steel" />
                        ...
                        <div>
                           <label htmlFor="telefone" className="block mb-2 text-sm font-medium text-gray-300">Telefone</label>
                            <div className="relative">
                               <Phone className="absolute inset-y-0 left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-steel" />
                               <IMaskInput
                                   mask="(00) 00000-0000"
                                   id="telefone"
                       ...
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                           <div>
                               ...
                               <div className="relative">
                                   <Calendar className="absolute inset-y-0 left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-steel" />
                                   <input type="date" id="data" {...register('data', { required: true })}
                                          className="w-full pl-10 pr-4 py-3 rounded-lg bg-black-medium border border-black-light focus:outline-none input-field text-sm text-white placeholder-gray-steel dark-picker" />
                               </div>
                           </div>
                           <div>
                               <label htmlFor="horario" className="block mb-2 text-sm font-medium text-gray-300">Horário</label>
                               <div className="relative">
                                   <Clock className="absolute inset-y-0 left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-steel" />
